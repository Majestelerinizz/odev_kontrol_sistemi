        ...
        data: (students) {
          if (students.isEmpty) {
            return const EmptyState(
              ...
              subtitle:
                  'Davet koduyla kayıt olduktan sonra deneme sonuçları burada görünür.',
            );
          }
            ...
            data: (exams) {
              if (exams.isEmpty) {
                return const EmptyState(
                  ...
                  subtitle:
                      'Öğretmen sonuç girdiğinde burada listelenir.',
                );
              }
              return _ExamResultsBody(exams: exams);
            },
          );
        },
      ),
...
class _ExamResultsBody extends StatelessWidget {
  const _ExamResultsBody({required this.exams});
  final List<ExamResultEntity> exams;
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(exam.examName, style: AppTextStyles.h4),
                      ),
                      Text(
